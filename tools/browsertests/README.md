...
Draaien tegen een lokale webserver met de inhoud van de repo (`public\` in de OneDrive-map) op poort 8765:
    ...
    python leeg-en-welcome.py      # Start empty op het startscherm, het blok Start here met één primaire knop, geen Recently edited zonder eigen werk, de kolom Cost pas met een prijs, een kaal databestand dat + New formula en + New material niet laat crashen (15 controles)
