...
Draaien tegen een lokale webserver met de inhoud van `public\` op poort 8765:
    ...
    python file-mode.py            # gedownloade app via file://: hint, starterset van miformulas.com (nagebootst), databestand aanmaken (37 controles, incl. herstart met Reopen; geen webserver nodig)
